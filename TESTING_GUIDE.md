...
2. **Double-click `login.php`** or any of the PHP files directly
...
**What to test:**
- ✅ Click "Login as Student" → Goes to student.php
- ✅ Click "Login as Professor" → Goes to professor.php
- ✅ Click "Login as Administrator" → Goes to admin.php
